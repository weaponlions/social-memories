...
import {avatar, paper, form, submit, googleButton, root} from "./styles";
...
import { Grid, Avatar, Paper, Button, Container, Typography } from "@mui/material";
...
export const Auth = () => {
 ...
 const Sleep = (time) => {
  ...
  return (
    <>  
      { !isLoading && 
        (<Container component="main" maxWidth="xs" sx={root}>
